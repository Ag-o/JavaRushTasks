...
public class Solution {
    ...
    public static void main(String[] args) {
        Solution.TableInterfaceWrapper tableInterfaceWrapper = new Solution().new TableInterfaceWrapper(new TableInterface() {
            @Override
            public void setModel(List rows) {
        ...
        tableInterfaceWrapper.component.setHeaderText("xxx");
    }
}
