...
public class Solution implements Serializable {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Singleton singleton0 = deserializeSingletonInstance(byteArrayOutputStream);
        Singleton singleton1 = deserializeSingletonInstance(byteArrayOutputStream);

        System.out.println("Instance0 : " + singleton0.getInstance());
        System.out.println("Instance1 : " + singleton1.getInstance());
        System.out.println();
