...
public class OurHashMapStorageStrategy implements StorageStrategy {
    ...
    public Entry getEntry(Long key) {
        ...
        for (Entry e = this.entries[indexFor(hash, this.entries.length)]; e != null; e = e.next) {
            Long k;
    ...
    public void addEntry(int hash, Long key, String value, int bucketIndex) {
        ...
        this.entries[bucketIndex] = new Entry(hash, key, value, e);
    ...
    public void put(Long key, String value) {
        ...
        for (Entry e = this.entries[index]; e != null; e = e.next) {
            Long k;
    ...
    public Long getKey(String value) {
        for (int i = 0; i < this.entries.length; i++) {
            for (Entry e = this.entries[i]; e != null; e = e.next) {
