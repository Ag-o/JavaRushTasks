...
public class LogParser implements IPQuery, UserQuery, DateQuery, EventQuery, QLQuery {
    ...
    public Set<String> getIPsForUser(String user, Date after, Date before) {
        return getLogEntriesInGivenPeriodOfTime(after, before)
                ...
                .collect(HashSet::new, (set, item) -> set.add(item.getIp()), AbstractCollection::addAll);
    }
    ...
    public Set<String> getAllUsersInGivenPeriodOfTime(Date after, Date before) {
        return getLogEntriesInGivenPeriodOfTime(after, before)
                .stream()
                .collect(HashSet::new, (set, item) -> set.add(item.getUser()), AbstractCollection::addAll);
    }
    ...
    public Set<String> getSetOfUniqueIPsInGivenPeriodOfTime(Date after, Date before) {
        ...
        return logEntries.stream()
                ...
                .collect(HashSet::new, (list, item) -> list.add(item.getIp()), AbstractCollection::addAll);
    }
    ...
    public Set<String> getAllUsers() {
        return getLogEntries().stream()
                .collect(HashSet::new, (list, item) -> list.add(item.getUser()), AbstractCollection::addAll);
    }
    ...
    public int getNumberOfUserEvents(String user, Date after, Date before) {
        Set<Event> uniqueEventsForCurrentUser = getLogEntriesInGivenPeriodOfTime(after, before)
                .stream()
                .filter(e -> e.getUser().equals(user))
                .collect(HashSet::new, (set, item) -> set.add(item.getEvent()), AbstractCollection::addAll);
    ...
    public Set<Date> getDatesForUserAndEvent(String user, Event event, Date after, Date before) {
        return getLogEntriesInGivenPeriodOfTime(after, before)
                ...
                .filter(e -> e.getUser().equals(user))
                .filter(e -> e.getEvent().equals(event))
                .collect(HashSet::new, (set, item) -> set.add(new Date(item.getDate())), AbstractCollection::addAll);
    }
    ...
    private Date getDateForUserAndEventFirstTime(String user, Event event, Date after, Date before) {
        ...
        if (entries.size() > 0) {
            Long firstDate = entries.stream().mapToLong(LogEntry::getDate).min().getAsLong();
    ...
    private Date getDateWhenUserEventHappendWithTaskFirstTime(String user, Event event, int task, Date after, Date before) {
        List<Long> solveTaskDates = getLogEntriesInGivenPeriodOfTime(after, before)
                ...
                .filter(e -> e.getEvent().equals(event))
                .filter(e -> e.getTaskNumber() == task)
                .collect(ArrayList::new, (list, item) -> list.add(item.getDate()), ArrayList::addAll);
        ...
        switch (currentQuery) {
            ...
            case "date":
                return new HashSet<>(getLogEntries()
                        .stream()
                        .collect(HashSet::new, (set, item) -> set.add(new Date(item.getDate())),
            ...
            case "status":
                return new HashSet<>(getLogEntries()
                        .stream()
                        .collect(HashSet::new, (set, item) -> set.add(item.getStatus()),
                                AbstractCollection::addAll));
